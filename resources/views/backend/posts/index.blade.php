          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left fs-sm">
                <a class="btn btn-sm btn-alt-secondary" href="{{ route('admin.posts.show', $post->id) }}" data-bs-toggle="tooltip" title="View">
                  <i class="fa fa-fw fa-eye"></i>
                </a>
                <a class="btn btn-sm btn-alt-warning" href="{{ route('admin.posts.edit', $post->id) }}" data-bs-toggle="tooltip" title="Edit">
            ...
            <tr>
                <td colspan="4" class="d-none d-sm-table-cell fs-sm text-center">
                  <p calss="text-center">No posts</p>
                </td>
