      ...
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-2">
            ...
            <div class="">
                <a class="btn btn-success mt-2 mb-0" href="{{ route('admin.portfolio.create') }}">
      ...
      <div class="block-content block-content-full">
        ...
        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
          <thead>
            <tr>
              <th>Title</th>
              <th class="d-none d-sm-table-cell" style="width: 30%;">English Title</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="d-none d-sm-table-cell fs-sm">
                {!!  substr(strip_tags($user->name_en), 0, 50) !!} 
              </td>
              ...
              <td class="text-left fs-sm">
                <a class="btn btn-sm btn-alt-secondary" href="{{ route('admin.portfolio.show', $user->id) }}" data-bs-toggle="tooltip" title="View">
                  <i class="fa fa-fw fa-eye"></i>
                </a>
                <a class="btn btn-sm btn-alt-warning" href="{{ route('admin.portfolio.edit', $user->id) }}" data-bs-toggle="tooltip" title="Edit">
            ...
            <tr>
                <td colspan="5" class="d-none d-sm-table-cell fs-sm text-center">
                  <p calss="text-center">No images</p>
                </td>
