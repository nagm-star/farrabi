                  ...
                  @endif
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                          ...
                          <p style="color:red; !important; top:2px;">Recommended size: 960x720 pixles</p>
                          </div>
                ...
                <div class="form-group row mb-2">
                    <div class="col-sm-10">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" value="{{ isset($portfolio) ? $portfolio->status : 1 }}"
                             id="status" name="status" @if(isset($portfolio) && $portfolio->status === 1) checked @endif >
