...
<!-- ======= Portfolio Section ======= -->
            <section id="portfolio" class="portfolio">
              <div class="container" data-aos="fade-up">
                  ...
                  <div class="section-title">
                      <h2>{{ __('translate.content.mediagallery' )}}</h2>
                      {{-- <h3>Check our <spZZan>Portfolio</span></h3> --}}
                  </div>
                  ...
                  <div class="row" data-aos="fade-up" data-aos-delay="100">
                      <div class="col-lg-12 d-flex justify-content-center">
                          <ul id="portfolio-flters">
                             ...
                             <?php $filter = substr($portfolio->name_en, 0, 3); ?>     
                             <li data-filter=".{{$filter}}">{{ $lang=='ar' ? $portfolio->name : $portfolio->name_en }}</li>
                             @endforeach
                          </ul>
                      </div>
                  </div>
            ...
            @foreach ($portfolios as $portfolio)                
                    <?php $filterApp = substr($portfolio->name_en, 0, 3); ?>     
